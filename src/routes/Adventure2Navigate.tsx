...
const firstStopLocation: [number, number] = [50.98292008983752, 12.993287092501584];
...
export default function Adventure2Navigate() {
        ...
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', top: 56, left: 0, right: 0, bottom: 0, zIndex: 0 }}>
                <MapContainer style={{ height: '100%', width: '100%' }}>
                    ...
                    <Marker position={firstStopLocation} icon={userIcon} />
                    <Marker position={nextStop.coords} />

                    <RoutingControl waypoints={[firstStopLocation, nextStop.coords]} />
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/adventure-1stop')}
                    style={{
                        position: 'absolute',
                        left: 16,
                        background: 'none',
