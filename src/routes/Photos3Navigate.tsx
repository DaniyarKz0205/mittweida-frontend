...
const fixedUserLocation: [number, number] = [51.011050243396106, 12.982171995464338];
...
const nextStop = {
    title: 'Nunc auctor',
    coords: [51.01664587720255, 12.979071361837345] as [number, number],
    distance: '350 m',
    eta: '12:46',
    duration: '5 min',
};
...
export default function Photos3Navigate() {
        ...
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', top: 56, left: 0, right: 0, bottom: 0, zIndex: 0 }}>
                <MapContainer style={{ height: '100%', width: '100%' }}>
                    ...
                    <RoutingControl waypoints={[fixedUserLocation, nextStop.coords]} />
