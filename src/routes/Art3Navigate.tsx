...
const secondStopLocation: [number, number] = [50.984399271347044, 12.959866768098719];
...
const nextStop = {
    title: 'Proin gravida',
    coords: [50.98080752355647, 12.974789008549664] as [number, number],
    distance: '350 m',
    eta: '12:46',
    duration: '5 min',
};
...
export default function Art3Navigate() {
