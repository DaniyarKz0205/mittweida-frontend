...
const thirdStopLocation: [number, number] = [50.99569558260419, 12.930368133422409];
...
export default function Forest4Navigate() {
        ...
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', top: 56, left: 0, right: 0, bottom: 0, zIndex: 0 }}>
                <MapContainer style={{ height: '100%', width: '100%' }}>
                    ...
                    <Marker position={thirdStopLocation} icon={userIcon} />
                    <Marker position={nextStop.coords} />

                    <RoutingControl waypoints={[thirdStopLocation, nextStop.coords]} />
