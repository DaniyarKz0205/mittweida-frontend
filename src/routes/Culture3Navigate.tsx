...
const secondStopLocation: [number, number] = [50.986634839497746, 12.9918172420656];
...
const nextStop = {
    title: 'Nullam sit',
    coords: [50.98840430658253, 12.99227858195385] as [number, number],
    distance: '350 m',
    eta: '12:46',
    duration: '5 min',
};
...
export default function Culture3Navigate() {
    ...
    return (
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/culture-2stop')}
                    style={{
                        position: 'absolute',
                        left: 16,
                        background: 'none',
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/culture-3stop')}
                    style={{
                        marginTop: '16px',
                        width: '100%',
                        padding: '14px',
