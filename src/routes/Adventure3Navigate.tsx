...
const secondStopLocation: [number, number] = [50.97627332345514, 13.001183515912093];
...
const nextStop = {
    ...
    coords: [50.98841781375424, 13.006000763257253] as [number, number],
    distance: '350 m',
    eta: '12:46',
    duration: '5 min',
};
...
export default function Adventure3Navigate() {
        ...
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'absolute', top: 56, left: 0, right: 0, bottom: 0, zIndex: 0 }}>
                <MapContainer style={{ height: '100%', width: '100%' }}>
                    ...
                    <Marker position={secondStopLocation} icon={userIcon} />
                    <Marker position={nextStop.coords} />

                    <RoutingControl waypoints={[secondStopLocation, nextStop.coords]} />
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/adventure-2stop')}
                    style={{
                        position: 'absolute',
                        left: 16,
                        background: 'none',
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/adventure-3stop')}
                    style={{
                        marginTop: '16px',
                        width: '100%',
                        padding: '14px',
