...
const secondStopLocation: [number, number] = [50.978056609887474, 12.956684517088167];
...
export default function Hilltop4Navigate() {
    ...
    return (
        <div style={{ position: 'relative', height: '100vh', overflow: 'hidden' }}>
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/hilltop-3stop')}
                    style={{
                        position: 'absolute',
                        left: 16,
                        background: 'none',
            ...
            <div
                ...
                <button
                    onClick={() => navigate('/hilltop-4stop')}
                    style={{
                        marginTop: '16px',
                        width: '100%',
                        padding: '14px',
